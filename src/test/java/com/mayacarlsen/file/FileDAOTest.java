...
public class FileDAOTest {
    ...
    public void testGetExistingFile() throws Exception {
        File file1 = FileDAO.getFile(57);
        logger.info("file1=" + file1);

        File file2 = new File(57, 1, "TEST", "TEST", "TEST", null, null, false, null, null, null, null);
        int count = FileDAO.updateFile(file2);
        logger.info("count=" + count);

        File file3 = FileDAO.getFile(57);
